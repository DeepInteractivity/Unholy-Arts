...
window.PersonalRoom = function() {
	this.roomState = "main"; // Alts: "charInfo" , "customizeMood" , "scrolls" , "candidatesComparison" , "endDayScreen"
