...
// State.variables.StVarsList = []; // Ex.: isStVarOn("GcEndC") // removeFromStVarsList("HdRlts"); addToStVarsList("GcEndC");
...
setup.versionName = "Unholy Arts v0.3.17";
