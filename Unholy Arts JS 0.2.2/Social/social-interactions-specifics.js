...
window.createSistOfferTutorshipAsTutor = function() {
	...
	sist.isPossible = function(actor,target) {
		...
		if ( (gSettings().relationshipTypesAllowed == true) && ( gC(actor).type == "candidate" ) &&
		  ...
		  && ( gC(target).subChars.length < 1 ) && ( gC(target).domChar == null ) ) {
			flagPossible = true;
		}
		return flagPossible;
	}
	...
	sist.isSuccessful = function(actor,target) {
		...
		var semifinalValue = targetMoodFactor + relationshipFactor + competitionFactor + infamyFactor;
		var sfvTenth = semifinalValue * 0.1;
		var diceThrow = luckedDiceThrow(gC(actor).luck.getValue());
		var luckFactor = (sfvTenth * 2 * diceThrow) - sfvTenth;
		...
		var finalValue = semifinalValue + luckFactor;
		if ( finalValue >= baseDifficulty ) { result = true; }
		stringResult += " Mood: " + targetMoodFactor.toFixed(2) + ", Relationship: " + relationshipFactor.toFixed(2) + ", Competition: " + competitionFactor.toFixed(2) + ", Infamy: " + infamyFactor.toFixed(2) + ", Luck: " + luckFactor.toFixed(2)
					  + " -> Result: " + finalValue.toFixed(2) + " VS Difficulty: " + baseDifficulty;
...
window.createSistOfferTutorshipAsPupil = function() {
	...
	sist.isSuccessful = function(actor,target) {
		...
		var semifinalValue = targetMoodFactor + relationshipFactor + competitionFactor;
		var sfvTenth = semifinalValue * 0.1;
		var diceThrow = luckedDiceThrow(gC(actor).luck.getValue());
		var luckFactor = (sfvTenth * 2 * diceThrow) - sfvTenth;
		...
		var finalValue = semifinalValue + luckFactor;
		if ( finalValue >= baseDifficulty ) { result = true; }
		stringResult += " Mood: " + targetMoodFactor.toFixed(2) + ", Relationship: " + relationshipFactor.toFixed(2) + ", Competition: " + competitionFactor.toFixed(2) + ", Luck: " + luckFactor.toFixed(2)
					  + " -> Result: " + finalValue.toFixed(2) + " VS Difficulty: " + baseDifficulty;
