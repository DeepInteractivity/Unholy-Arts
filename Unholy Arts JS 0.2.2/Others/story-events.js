...
window.initializeSeAspiringTreeClimber = function () {
	...
	if ( ( gCstat("chPlayerCharacter","physique") + gCstat("chPlayerCharacter","resilience") + (gCstat("chPlayerCharacter","agility") / 2) ) >= 30 ) {
		State.variables.StVars.check2 = true;
	}
	...
	if ( ( gCstat("chPlayerCharacter","physique") + gCstat("chPlayerCharacter","resilience") ) >= 30 ) {
		State.variables.StVars.check5 = true;
	}
