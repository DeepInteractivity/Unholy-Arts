...
window.createSystemEventStandardRest = function(minutes,characters) {
	var sEvent = new systemEvent(minutes,characters,"standardRest","Rest for one hour",function(cList) {
			...
			if ( cList.length > 1 ) {
				var eventMsg = "" + ktn(cList[0]) + " and the others rested for an hour, recovering lust, "
...
window.createTrainingActionDramaReading = function() {
	...
	action.description = "The characters will make critical readings of different drama plays to train their empathy.";
...
window.createTrainingActionDramaActing = function() {
	...
	action.description = "The characters will train their charisma playing different roles in the stage.";
...
window.createTrainingActionWaterfallMeditation = function() {
	...
	action.description = "Mysterious are the ways of the world, and characters immersing themselves within it will be at harmony with the Universe.";
...
window.createTrainingActionSwimming = function() {
	...
	action.description = "The characters will train their resilience swimming in the river.";
...
window.createTrainingActionAerobics = function() {
	...
	action.description = "The characters will do aerobic execises to train their agility.";
...
window.createTrainingActionAnaerobics = function() {
	...
	action.description = "The characters will do anaerobic execises to train their physique.";
...
window.createTrainingActionMeditation = function() {
	...
	action.description = "The characters will look deep into every dimension of themselves, hardening in the face of adversity and training their will.";
...
window.createTrainingActionSpellcasting = function() {
	...
	action.description = "The characters will practice different spells, training their intelligence.";
...
window.createTrainingActionEnergyReading = function() {
	...
	action.description = "The characters will train their perception by looking for different magical waves and streams.";
