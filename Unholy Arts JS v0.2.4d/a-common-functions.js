...
window.applyHotfix = function() {
	gC("chNash").globalAi = createCandidateGlobalAi("chNash");
	gC("chMir").globalAi = createCandidateGlobalAi("chMir");
	gC("chClaw").globalAi = createCandidateGlobalAi("chClaw");
	gC("chVal").globalAi = createCandidateGlobalAi("chVal");
	gC("chAte").globalAi = createCandidateGlobalAi("chAte");
