...
window.applyHotfix = function() {
	gC("chVal").relations.chClaw.friendship = new RelPar(250,0);
	gC("chVal").relations.chClaw.sexualTension = new RelPar(250,0);
	gC("chClaw").relations.chVal.friendship = new RelPar(250,0);
	gC("chClaw").relations.chVal.sexualTension = new RelPar(250,0);
	
	State.variables.compass.initializeMap = function(mapKey,roomKey) {
