...
window.returnAttributeTooltip = function(attribute) {
	...
	switch (attribute) {
		...
		case "empathy":
			...
			break;
		case "charisma":
			tooltip = "<span title='Charisma is used to convey your feelings and heating up the emotions of"
					+ " others. It will help you develop your relationships and preventively watering groins.'>^^(?)^^</span>";
			break;
		case "luck":
...
window.configureBattleTestsRoomScene = function() {
	State.variables.sc.startScene("bs", "none",
		...
		"wow such testz",endConditionTurns,100,
		"Testing Scenes Room");
	State.variables[State.variables.tsr.character].aiAlgorythm = createAiRandomAction();
}
...
window.setUpTestScenesRoom = function() {
	...
	"scissor","strokeAss","penetrateAss","analThrust","holdArms","vinesHoldArms","dickFootjob","pussyFootjob","lickLegs"]);
...
window.setUpMultiBattleTest = function() {
	...
	State.variables.sc.startScene("bs", "none",
		...
		"Testing Scenes Room");
	State.variables.chAte.aiAlgorythm = createAiRandomActionRandomOpponent();
	State.variables.chNash.aiAlgorythm = createAiRandomActionRandomOpponent();
	State.variables.chVal.aiAlgorythm = createAiRandomActionRandomOpponent();
