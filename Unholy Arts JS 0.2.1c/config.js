...
window.Settings = function() { 
	...
	this.autosaving = "disable"; // "enable" / "disable"
...
State.variables.creditsGoddessEnthusiast = [ "LessIDableName ","Sordax","Fox McQwerty","ben ","Peter ","Troy Armstrong","Colton Foote","Barnabas Collins","Vadrin ","Jake Ross","Gura ","ThatsAllFolks ","Nevyn ","Tyler Kreutzer","Pandavenger ","Chris40 ","He Who Remembers All","Ross Fountain","Bluebomber ","Brian Keefe","hiorka","ElCrazy1 ","Hairdevill","Grissie","Jacob LaRiviere","ShardOfCard ","ElrondHubbard ","Thomas Colasanto","Nat Byham","Evgeniy ","Cody Shawver","Brad11 ","tiffany mawhorter","Trickster ","Georgii Brisuela","Anonimus Mito" ];
State.variables.creditsPassionTemplePreacher = [ "Ryuko ","aattss ","Samurai_Jack141 ","Name2146 ","Snakes! ","Irasur","Alex ","Nathaniel Grams","Cory Elliott","SenoirKain ","Andreas","Joshua Boguth","Joshua Smith","Thomas ","Emily S.","Hunter Glad","Devin White","Anon ","dark_dragon ","A giant crab","Kai Scheele","pyrite" ];
