...
window.createPlayerCharacter = function() {
	...
	// Moves
	character.saList.push("strokePussy","strokeBreasts","strokeDick","kissLips","frottage","frenchKiss","mountFaceToFace","penetratePussy","interlockLegs","lickGroin");
...
window.createNashillbyir = function() {
	...
	character.saList.push("baKissLips","baStrokeDick","baStrokePussy","pounceFrontalD2P","pounceFrontalP2P","pounceFrontalP2D","baThrust","baPushHipsBack","baScissor","baScissorBack","baRideDick","baPushDickBack","kick","coldGuts","taunt","baTease");
	*/
	character.saList.push("baKissLips","pounceFrontalD2P","pounceFrontalP2P","pounceFrontalP2D","baThrust","baPushHipsBack","baScissor","baScissorBack","baRideDick","baPushDickBack","kick","coldGuts","taunt","sparkingRubbing");
	...
	// Drives
	character.dImprovement.setValues(1800,4);
	character.dPleasure.setValues(650,2);
	character.dLove.setValues(300,1);
	character.dCooperation.setValues(900,2);
	character.dDomination.setValues(450,1);
	character.dAmbition.setValues(500,1);
	
	// Attributes
	character.setBaseAttributes(14,16,12,8,10,14,10,12,12);
	character.setAffinities(1.1,1.2,1,0.8,0.9,1.1,0.9,1,1);
	
	character.recalculateMaxBars();
...
window.createPadmiri = function() {
	...
	character.saList.push("baKissLips","baStrokeDick","baStrokePussy","pounceFrontalD2P","pounceFrontalP2P","pounceFrontalP2D","baThrust","baPushHipsBack","baScissor","baScissorBack","baRideDick","baPushDickBack","kick","coldGuts","taunt","baTease");
	*/
	character.saList.push("baKissLips","pounceFrontalP2P","pounceFrontalP2D","baThrust","baPushHipsBack","baScissor","baScissorBack","baRideDick","baPushDickBack","kick","freezeFeet","taunt","baTease");
	...
	// Drives
	character.dImprovement.setValues(900,2);
	character.dPleasure.setValues(450,1);
	character.dLove.setValues(750,2);
	character.dCooperation.setValues(1800,4);
	character.dDomination.setValues(50,0);
	character.dAmbition.setValues(800,2);
...
window.createCarine = function() {
	...
	character.saList.push("baKissLips","baStrokeDick","baStrokePussy","pounceFrontalD2P","pounceFrontalP2P","pounceFrontalP2D","baThrust","baPushHipsBack","baScissor","baScissorBack","baRideDick","baPushDickBack","kick","coldGuts","taunt","baTease");
	*/
	character.saList.push("pounceFrontalD2P","pounceFrontalP2P","baThrust","baPushHipsBack","baScissor","baScissorBack","baRideDick","baPushDickBack","kick","coldGuts","taunt");
	...
	// Affinities
	character.combatAffinities.pounce.strength += 15;
	...
	// Drives
	character.dImprovement.setValues(1400,3);
	character.dPleasure.setValues(750,2);
	character.dLove.setValues(0,0);
	character.dCooperation.setValues(0,0);
	character.dDomination.setValues(1800,4);
	character.dAmbition.setValues(1200,3);
...
window.createValtan = function() {
	...
	*/
	...
	character.tastes.oral.w = 90;
	character.tastes.talk.w = 105;
	character.tastes.fullsex.w = 100;
	...
	// Drives
	character.dImprovement.setValues(850,2);
	character.dPleasure.setValues(1800,4);
	character.dLove.setValues(400,1);
	character.dCooperation.setValues(350,1);
	character.dDomination.setValues(1200,3);
	character.dAmbition.setValues(500,1);
...
window.createMaaterasu = function() {
	...
	character.saList.push("baKissLips","baStrokeDick","baStrokePussy","pounceFrontalD2P","pounceFrontalP2P","pounceFrontalP2D","baThrust","baPushHipsBack","baScissor","baScissorBack","baRideDick","baPushDickBack","kick","coldGuts","taunt","baTease");
	*/
	character.saList.push("baKissLips","pounceFrontalD2P","pounceFrontalP2P","pounceFrontalP2D","baThrust","baPushHipsBack","baScissor","baScissorBack","baRideDick","baPushDickBack","embers","freezeFeet","sparkingRubbing");
	// Body
	character.addFemaleParts();
	// Others
	...
	// Affinities
	character.combatAffinities.physical.resistance += 20;
	character.combatAffinities.physical.frailty += 20;
	character.combatAffinities.magic.strength += 20;
	...
	// Drives
	character.dImprovement.setValues(1700,4);
	character.dPleasure.setValues(300,1);
	character.dLove.setValues(300,1);
	character.dCooperation.setValues(300,1);
	character.dDomination.setValues(300,1);
	character.dAmbition.setValues(850,2);
